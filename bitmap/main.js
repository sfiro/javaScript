//  Se crea un canvas y se dibuja un circulo en el centro, 
// luego se crea un objeto particle que se mueve hacia el circulo y lo atraviesa,
// luego se reinicia la posicion del objeto particle y se repite el proceso.
...
window.onload=function(){
    ...
    var p = particle.create(0, height/2, 10, 0);

//  Se crea un objeto que rebotará en los bordes, debido a la definición de limite y se toma en consideración el radio del elemento
...
var canvas = document.getElementById("canvas");
  ...
  height = canvas.height = window.innerHeight;
   ...
   var ship = particle.create(width/2,height/2,5,Math.random()*Math.PI*2,0),

...
var canvas = document.getElementById("canvas");
  ...
  height = canvas.height = window.innerHeight;
   ...
   var ship = particle.create(width/2,height/2,3,Math.random()*Math.PI*2,0),
   ...
   function update(){
     ...
     // se verifica que el objeto supere el radio en todos los bordes antes de aparecer en el otro extremo
